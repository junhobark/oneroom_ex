...
class GeneralBoardWrite extends StatefulWidget {
  ...
  @override
  State<GeneralBoardWrite> createState() => _GeneralBoardWriteState();
}

class _GeneralBoardWriteState extends State<GeneralBoardWrite> {
  ...
  void _generalBoardWriteState() async {
    final dio = Dio();
