...
class communityScreenSearch extends StatefulWidget {
  ...
  @override
  _communityScreenSearchState createState() => _communityScreenSearchState();
}

class _communityScreenSearchState extends State<communityScreenSearch> {
  ...
  Future<void> fetchData() async {
    ...
    final url = Uri.parse(
        'http://10.0.2.2:8080/community/search?word=$searchKeyword');
