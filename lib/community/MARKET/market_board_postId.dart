...
import 'package:oneroom_ex/community/MARKET/market_board_write_edit.dart';
import 'package:oneroom_ex/login/uid_provider.dart';
import 'package:provider/provider.dart';

class MarketBoardPostId extends StatefulWidget {
  final int id;

  MarketBoardPostId(this.id);

  @override
  _MarketBoardPostIdState createState() => _MarketBoardPostIdState();
}

class _MarketBoardPostIdState extends State<MarketBoardPostId> {
  ...
  Future<void> fetchData() async {
    var url = Uri.parse('http://10.0.2.2:8080/community/MARKET/${widget.id}');
  ...
  Future<void> deletePost() async {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(
        //pop으로 뒤로못가게push
        context,
        MaterialPageRoute(builder: (context) => MarketBoardScreen()),
      );
    } else {
  ...
  Future<void> deleteComment(int commentId) async {
    var url = Uri.parse(
        'http://10.0.2.2:8080/community/MARKET/${widget.id}/${commentId}');
    var response = await http.delete(url);
  ...
  Future<void> postLike() async {
    var url =
    Uri.parse('http://10.0.2.2:8080/community/MARKET/${widget.id}/like');
  ...
  Future<void> commentLike(int commentId) async {
    var url = Uri.parse(
        'http://10.0.2.2:8080/community/MARKET/${widget.id}/${commentId}/like');
    var body = {"memberId": "${Provider.of<UIDProvider>(context,listen: false).uid}"};
  ...
  Future<void> postComment() async {
    var url = Uri.parse(
        'http://10.0.2.2:8080/community/MARKET/${widget.id}/writeComment');
    var body = {
