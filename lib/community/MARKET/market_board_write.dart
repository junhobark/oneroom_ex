...
class MarketBoardWrite extends StatefulWidget {
  const MarketBoardWrite({Key? key}) : super(key: key);

  @override
  State<MarketBoardWrite> createState() => _MarketBoardWriteState();
}

class _MarketBoardWriteState extends State<MarketBoardWrite> {
  ...
  void _marketBoardWriteState() async {  //1
    final dio = Dio();
    var url = 'http://10.0.2.2:8080/community/MARKET/write';
