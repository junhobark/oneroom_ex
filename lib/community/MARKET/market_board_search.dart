...
class MarketBoardSearch extends StatefulWidget {
  const MarketBoardSearch({Key? key}) : super(key: key);

  @override
  _MarketBoardSearchState createState() => _MarketBoardSearchState();
}

class _MarketBoardSearchState extends State<MarketBoardSearch> {
  ...
  Future<void> fetchData() async {
    ...
    final url = Uri.parse(
        'http://10.0.2.2:8080/community/MARKET/search?word=$searchKeyword');
