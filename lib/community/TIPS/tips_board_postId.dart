...
import 'package:oneroom_ex/community/TIPS/tips_board_screen.dart';
import 'package:oneroom_ex/community/TIPS/tips_board_write_edit.dart';
import 'package:oneroom_ex/login/uid_provider.dart';
import 'package:provider/provider.dart';

class TipsBoardPostId extends StatefulWidget {
  final int id;

  TipsBoardPostId(this.id);

  @override
  _TipsBoardPostIdState createState() => _TipsBoardPostIdState();
}

class _TipsBoardPostIdState extends State<TipsBoardPostId> {
  ...
  Future<void> fetchData() async {
    var url = Uri.parse('http://10.0.2.2:8080/community/TIPS/${widget.id}');
  ...
  Future<void> deletePost() async {
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.pushReplacement(
        //pop으로 뒤로못가게push
        context,
        MaterialPageRoute(builder: (context) => TipsBoardScreen()),
      );
    } else {
  ...
  Future<void> deleteComment(int commentId) async {
    var url = Uri.parse(
        'http://10.0.2.2:8080/community/TIPS/${widget.id}/${commentId}');
    var response = await http.delete(url);
  ...
  Future<void> postLike() async {
    var url =
    Uri.parse('http://10.0.2.2:8080/community/TIPS/${widget.id}/like');
  ...
  Future<void> commentLike(int commentId) async {
    var url = Uri.parse(
        'http://10.0.2.2:8080/community/TIPS/${widget.id}/${commentId}/like');
    var body = {"memberId": "${Provider.of<UIDProvider>(context,listen: false).uid}"};
  ...
  Future<void> postComment() async {
    var url = Uri.parse(
        'http://10.0.2.2:8080/community/TIPS/${widget.id}/writeComment');
    var body = {
