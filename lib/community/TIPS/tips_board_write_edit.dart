...
class TipsBoardWriteEdit extends StatefulWidget {
  final int id;

  const TipsBoardWriteEdit({Key? key, required this.id}) : super(key: key);

  @override
  State<TipsBoardWriteEdit> createState() => _TipsBoardWriteEditState();
}

class _TipsBoardWriteEditState extends State<TipsBoardWriteEdit> {
  //get
  ...
  Future<void> fetchData() async {
    var url =
    Uri.parse('http://10.0.2.2:8080/community/TIPS/${widget.id}/modify');
  ...
  void _tipsBoardWriteEditState() async {
    final dio = Dio();
    var url = 'http://10.0.2.2:8080/community/TIPS/${widget.id}/modify';
