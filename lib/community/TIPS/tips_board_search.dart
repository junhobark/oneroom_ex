...
class TipsBoardSearch extends StatefulWidget {
  const TipsBoardSearch({Key? key}) : super(key: key);

  @override
  _TipsBoardSearchState createState() => _TipsBoardSearchState();
}

class _TipsBoardSearchState extends State<TipsBoardSearch> {
  ...
  Future<void> fetchData() async {
    ...
    final url = Uri.parse(
        'http://10.0.2.2:8080/community/TIPS/search?word=$searchKeyword');
