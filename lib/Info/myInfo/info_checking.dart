...
class informationCheckingScreen extends StatefulWidget {
  const informationCheckingScreen({Key? key}) : super(key: key);

  @override
  State<informationCheckingScreen> createState() => _informationCheckingScreen();
}

class _informationCheckingScreen extends State<informationCheckingScreen> {
